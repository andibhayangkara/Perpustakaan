...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/dina.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-box-body text-center bg-blue" style="font-size:22px;">
    <a href="index.php" style="color: yellow;"><b>SISTEM INFORMASI PERPUSTAKAAN</b> <br/><b>MTsN 4 BONE</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan MTsN 4 Bone - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
